...
class PasswordController extends AbstractController
{
    ...
    #[Route(path: '/password/{id}', name: 'extranet_user_password', methods: ['GET', 'POST'])]
    public function password(Request $request, User $user): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('extranet_user_show', ['id' => $user->getId()]);
        }

        return $this->render(
            '@Extranet/user/password.html.twig',
            [
                'user' => $user,
